...
bg_img = pygame.transform.scale(pygame.image.load('C:/Users/hp/Desktop/Python/Experiments/outdoor-bg.png').convert(),(w, h)) #resizing bg to the size of screen
penguin_image = pygame.transform.scale(pygame.image.load('C:/Users/hp/Desktop/Python/Experiments/penguin.png').convert_alpha(), (200,200)) #resiing the image to a specific size
